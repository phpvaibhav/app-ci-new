...
class Admin extends Common_Back_Controller {
    ...
    public function dashboard() {
        ...
        $chart_Data[] = array('label'=>'Teachers','link'=>'teacher-all','icon'=>'fa fa-vcard','count'=> $this->common_model->get_total_count('users',array('roleId'=>2)));
          ...
          $chart_Data[] = array('label'=>'Instruments','link'=>'instrument-all','icon'=>'fa fa-music','count'=> $this->common_model->get_total_count('instrument'));
          $chart_Data[] = array('label'=>'Tutorial','link'=>'tutorial-all','icon'=>'fa fa-tag','count'=> $this->common_model->get_total_count('tutorial'));
