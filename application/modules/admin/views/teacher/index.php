		...
		<div class="ibox float-e-margins">
        	...
        	<div class="ibox-content">
            	<div class="table-responsive">
        			<table class="table table-striped table-bordered table-hover dataTables-example-list" data-list-url="adminapi/teacher/list" data-id="<?= isset($_SESSION[USER_SESS_KEY]['instituteId'])?$_SESSION[USER_SESS_KEY]['instituteId']:0;?>" >
        				<thead>
					        <tr>
					            <th>S.No.</th>
					            <th>Image</th>
