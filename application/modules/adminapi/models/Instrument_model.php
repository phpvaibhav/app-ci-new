...
class Instrument_model extends CI_Model {
    ...
    var $column_order = array('i.instrumentId','i.name','i.status'); //set column field database for datatable orderable
    var $column_sel = array('i.instrumentId','i.name','i.image','i.status','(case when (i.status = 0) 
