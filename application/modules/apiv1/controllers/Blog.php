...
class Blog extends Common_Service_Controller{
    ...
    public function list_post(){
        ...
        $this->blog_model->set_data(array('userId'=>1));
       ...
       /*if($serData->status){
            ...
            $action .= '<a href="'.$link.'" onclick="confirmAction(this);" data-message="You want to change status!" data-id="'.encoding($serData->blogId).'" data-url="apiv1/blog/blogStatus" data-list="1"  class="on-default edit-row table_action" title="Status"><i class="fa fa-check" aria-hidden="true"></i></a>';
        }else{
            $action .= '<a href="'.$link.'" onclick="confirmAction(this);" data-message="You want to change status!" data-id="'.encoding($serData->blogId).'" data-url="apiv1/blog/blogStatus" data-list="1"  class="on-default edit-row table_action" title="Status"><i class="fa fa-times" aria-hidden="true"></i></a>';
        }*/
    
        $link = "javascript:void(0)";
        $editlink =base_url().'home/blog/edit/'.encoding($serData->blogId);
        
        $action .= '<a href="'.$editlink.'"  class="on-default edit-row table_action" title="Edit" ><i class="fa fa-edit" aria-hidden="true"></i></a>&nbsp;&nbsp;|&nbsp;&nbsp;'; 
        
        
        $userLink = base_url().'home/blog/detail/'.encoding($serData->blogId);
        
        $action .= '<a href="'.$userLink.'"  class="on-default edit-row table_action" title="Detail"><i class="fa fa-eye" aria-hidden="true"></i></a>';
      /*   $action .= '&nbsp;&nbsp;|&nbsp;&nbsp;<a href="'.$link.'" onclick="confirmAction(this);" data-message="You want to delete this record!" data-id="'.encoding($serData->blogId).'" data-url="apiv1/blog/blogDelete" data-list="1"  class="on-default edit-row table_action" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>';*/
        $row[]  = $action;
        $data[] = $row;
