...
class Plan extends Common_Service_Controller{
    ...
    public function list_post(){
       ...
       if($serData->status){
            ...
            $action .= '<a href="'.$link.'" onclick="confirmAction(this);" data-message="You want to change status!" data-id="'.encoding($serData->planId).'" data-url="apiv1/plan/planStatus" data-list="1"  class="on-default edit-row table_action" title="Status"><i class="fa fa-check" aria-hidden="true"></i></a>';
        }else{
            $action .= '<a href="'.$link.'" onclick="confirmAction(this);" data-message="You want to change status!" data-id="'.encoding($serData->planId).'" data-url="apiv1/plan/planStatus" data-list="1"  class="on-default edit-row table_action" title="Status"><i class="fa fa-times" aria-hidden="true"></i></a>';
        }
        ...
        $linkD = "javascript:void(0)";
         ...
         $action .= '&nbsp;&nbsp;|&nbsp;&nbsp;<a href="'.$linkD.'" onclick="confirmAction(this);" data-message="You want to delete this record!" data-id="'.encoding($serData->planId).'" data-url="apiv1/plan/planDelete" data-list="1"  class="on-default edit-row table_action" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>';
