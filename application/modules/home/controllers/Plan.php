...
class Plan extends Common_Front_Controller {
    ...
    public function index(){
        ...
        $data['front_scripts']    = array('common_assets/js/plugins/dataTables/datatables.min.js','common_assets/user/js/plan.js');
        $this->load->front_render('plan/index', $data, '');
    } //End function
    public function add(){
        $breadcrumb         = array(
        "Dashboard" => base_url(),
        ...
        $data['front_scripts']    = array('common_assets/js/plugins/dataTables/datatables.min.js','common_assets/js/plugins/summernote/summernote.min.js','common_assets/user/js/plan.js');
        $this->load->front_render('plan/add', $data, '');
    } //End function
