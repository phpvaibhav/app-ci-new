        ...
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                ...
                <div class="ibox-tools">
                    <a href="<?php echo base_url().'home/blog/add'; ?>" class="btn btn-primary" >
            ...
            <div class="ibox-content">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover dataTables-example-list" data-list-url="apiv1/blog/list" data-id="<?= $_SESSION[USER_SESS_KEY]['userId']; ?>" >
                        <thead>
                            <tr>
                                <th>S.No.</th>
                                <th>Image</th>
...
<!--  <div class="row">
                <div class="col-lg-4">
                    <div class="ibox">
                        <div class="ibox-content">
                            <a href="<?= base_url().'admin/blog/detail'; ?>" class="btn-link">
                                <h2>
