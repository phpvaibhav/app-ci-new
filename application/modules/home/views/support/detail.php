            ...
            <div class="ibox-content">
                ...
                <div class="row">
                    <div class="col-md-6">
                            <h5>Action:</h5>
                            <!-- <?php if(!$info['resolved']): ?>
                                <a href="javascript:void(0)" onclick="confirmAction(this);" data-message="You want to change resolve ticket!" data-id="<?= encoding($info['supportId']); ?>" data-url="apiv1/support/supportStatus" data-list="1"  class="on-default edit-row table_action" title="Resolve"><i class="fa fa-check" aria-hidden="true"></i></a>&nbsp;&nbsp;|&nbsp;&nbsp;
                            <?php endif; ?>
                            <a href="javascript:void(0);" onclick="confirmAction(this);" data-message="You want to delete this record!" data-id="<?= encoding($info['supportId']); ?>" data-url="apiv1/support/supportDelete" data-list="1"  class="on-default edit-row table_action" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a> -->
                ...
                <div class="row">
                  ...
                  <!--     <?php
                    ...
                    <?php } endif; ?>
                         <hr> 
                        <div class="">
                           <form class="form-horizontal"method="post" action="apiv1/support/supportReply" id="form-support-reply" enctype="multipart/form-data" novalidate autocomplete="off">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="hidden" name="userId" value="<?= $_SESSION[USER_SESS_KEY]['userId']; ?>">
