...
$("#form-add").validate({// Rules for form validation
  ...
  messages : {
        ...
        instrumentId : {
            required : 'Please enter your instrument'
        },
        description : {
        ...
        $.ajax({
            ...
            success: function (res) {
              ...
              if(res.status=='success'){
                ...
                setTimeout(function(){window.location = base_url+'all-blogs';; },4000);
    ...
    var formData = new FormData(this);
        ...
        cache           : false,
            ...
            success: function (res) {
              ...
              if(res.status=='success'){
                toastr.success(res.message, 'Success', {timeOut: 3000});
                setTimeout(function(){window.location = base_url+'all-blogs-institute';},4000);
              //  setTimeout(function(){ window.location = base_url+'jobs';; },4000);
              }else{
                toastr.error(res.message, 'Alert!', {timeOut: 4000});
              }
